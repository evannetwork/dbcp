...
export class Logger {
  ...
  constructor(options?) {
    ...
    this.logLevel = (options && typeof options.logLevel !== 'undefined') ? LogLevel[<string>options.logLevel] : LogLevel.error;
    this.logLogLevel = (options && options.logLogLevel !== 'undefined') ? LogLevel[<string>options.logLogLevel] : LogLevel.error;
